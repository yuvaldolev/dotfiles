" -----------------------------------------------------------------------------
" File: yd.vim
" Description: My custom color scheme based on Gruvbox.
" Author: ydolev
" -----------------------------------------------------------------------------
...
let s:gb.dark0_hard  = ['#201F21', 234]     " 29-32-33
...
let s:gb.light1      = ['#ab967e', 223]     " 235-219-178
...
let s:yd_keyword = ['#bf993f', 255]
let s:yd_constant = ['#8f8e40', 255]
...
call s:HL('YDKeyword', s:yd_keyword)
call s:HL('YDConstant', s:yd_constant)
call s:HL('YDPreproc', s:yd_preproc)
call s:HL('YDComment', s:yd_comment)
call s:HL('YDType', s:yd_type)
call s:HL('YDFunction', s:yd_function)
call s:HL('YDMacro', s:yd_macro)
...
hi! link Special YDConstant

call s:HL('Comment', s:yd_comment, s:none, s:italicize_comments)
call s:HL('Todo', s:vim_fg, s:vim_bg, s:bold . s:italic)
call s:HL('Error', s:red, s:vim_bg, s:bold . s:inverse)

" Generic statement
hi! link Statement YDKeyword
" if, then, else, endif, switch, etc.
hi! link Conditional YDKeyword
" for, do, while, etc.
hi! link Repeat YDKeyword
" case, default, etc.
hi! link Label YDKeyword
" try, catch, throw
hi! link Exception YDKeyword
" sizeof, "+", "*", etc.
hi! link Operator Normal
" Any other keyword
hi! link Keyword YDKeyword

" Variable name
hi! link Identifier Normal
" Function name
hi! link Function YDFunction

" Generic preprocessor
hi! link PreProc YDPreproc
" Preprocessor #include
hi! link Include YDPreproc
" Preprocessor #define
hi! link Define YDMacro
hi! link Macro YDMacro
" Preprocessor #if, #else, #endif, etc.
hi! link PreCondit YDPreproc

" Generic constant
hi! link Constant YDConstant
" Character constant: 'c', '/n'
hi! link Character YDConstant
" String constant: "this is a string"
hi! link String YDConstant
" Boolean constant: TRUE, false
hi! link Boolean YDConstant
" Number constant: 234, 0xff
hi! link Number YDConstant
" Floating point constant: 2.3e10
hi! link Float YDConstant

" Generic type
hi! link Type YDType
" static, register, volatile, etc
hi! link StorageClass YDKeyword
" struct, union, enum, etc.
hi! link Structure YDKeyword
" typedef
hi! link Typedef YDKeyword
...
hi! link vimNotation YDConstant
hi! link vimBracket YDConstant
hi! link vimMapModKey YDConstant
...
hi! link cOperator YDKeyword
hi! link cStructure YDKeyword
...
hi! link objcTypeModifier YDType
hi! link objcDirective YDKeyword
...
hi! link jsonKeyword YDKeyword
hi! link jsonQuote YDConstant
