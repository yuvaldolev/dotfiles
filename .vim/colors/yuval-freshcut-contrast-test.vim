...
let s:gb.light1      = ['#F8F8F2', 223]     " 235-219-178
...
let s:yd_keyword = ['#4ECDC4', 255]
let s:yd_constant = ['#8FBE00', 255]
let s:yd_string = ['#e9ee00', 255]
let s:yd_preproc = ['#C1B3A2', 255]
let s:yd_comment = ['#7D7D7D', 255]
let s:yd_type = ['#BA9341', 255]
let s:yd_function = ['#AEE239', 255]
...
call s:HL('YDString', s:yd_string)
...
if g:gruvbox_improved_strings == 0
  ...
  call s:HL('Special', s:yellow, s:bg1, s:italicize_strings)
endif
